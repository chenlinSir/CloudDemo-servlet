		...
		<div class="layui-header header">
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="../servlet/LostServlet?op=lost"><i class="iconfont icon-loginout"></i> 退出</a>
			    	</li>
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="../servlet/LostServlet?op=lost"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
