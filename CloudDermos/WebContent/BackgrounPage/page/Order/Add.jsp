		...
		layui.use(['form','layer'],function(){
			...
			form.render();
				...
				form.on('submit(update)',function(){
					...
					$.post("servlet/OrderServlet?op=Maint",FormDa,function(res){
						if(res>0){
...
<body class="childrenBody">
	...
	<input type="hidden" name="id" required  lay-verify="required" autocomplete="off" class="layui-input" id="id">
		...
		<div class="layui-form-item">
		   ...
		   <div class="layui-inline">
		     ...
		     <div class="layui-inline">
				...
				<div class="layui-input-block">
					<select class="staName2" lay-filter="staName2" name="staName2"  id="staName2">
						<option value="0" >==请选择==</option>					
				   </select>
				</div>
				</div>
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit lay-filter="update">立即添加</button>
